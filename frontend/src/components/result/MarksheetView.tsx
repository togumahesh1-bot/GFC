      ...
      >
        ...
        <div className="border-b-2 border-zinc-700/80 print:border-zinc-800 pb-6 text-center relative">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-2">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-blue-600 to-amber-500 p-1 flex items-center justify-center shadow-lg">
              <div className="w-full h-full bg-[#0d1017] print:bg-white rounded-xl flex items-center justify-center">
                <GraduationCap className="w-9 h-9 text-amber-400 print:text-blue-900" />
              </div>
            </div>
            <div>
